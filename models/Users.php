...
class Users extends UsersBase implements IdentityInterface
{
    ...
    const SCENARIO_AUTHORISATION='auth_scenario';
    ...
    public function setAuthorisationScenario(){
        $this->setScenario(self::SCENARIO_AUTHORISATION);
        return $this;
    }
    ...
    public function rules(){
        return array_merge([
                ...
                ['email','exist','on'=>self::SCENARIO_AUTHORISATION]
            ],parent::rules());
